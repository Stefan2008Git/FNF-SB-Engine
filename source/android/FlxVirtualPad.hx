		...
		if (ClientPrefs.data.gameStyle == 'SB Engine') {
			switch (DPad) {
				...
				case CHARACTER_EDITOR:
					dPad.add(add(buttonV = createButton(FlxG.width - 170 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "v", FlxColor.BROWN)));            
					dPad.add(add(buttonX = createButton(FlxG.width - 128 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "x", FlxColor.BROWN)));
					dPad.add(add(buttonY = createButton(FlxG.width - 86 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "y", FlxColor.BROWN)));
					dPad.add(add(buttonZ = createButton(FlxG.width - 44 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "z", FlxColor.BROWN)));
					dPad.add(add(buttonD = createButton(FlxG.width - 170 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "d", FlxColor.BROWN)));
					dPad.add(add(buttonF = createButton(FlxG.width - 170 * 3, FlxG.height - 250 * 3, 44 * 3, 127, "f", FlxColor.BROWN)));
					dPad.add(add(buttonC = createButton(FlxG.width - 128 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "c", FlxColor.BROWN)));
					dPad.add(add(buttonB = createButton(FlxG.width - 86 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "b", FlxColor.BROWN)));								
					dPad.add(add(buttonA = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "a", FlxColor.BROWN)));
					dPad.add(add(buttonUp2 = createButton(135 * 3, FlxG.height - 116 * 3, 44 * 3, 127, "up", FlxColor.BROWN)));
					dPad.add(add(buttonLeft2 = createButton(100, FlxG.height - 81 * 3, 44 * 3, 127, "left", FlxColor.BROWN)));
					dPad.add(add(buttonRight2 = createButton(169 * 3, FlxG.height - 81 * 3, 44 * 3, 127, "right", FlxColor.BROWN)));
					dPad.add(add(buttonDown2 = createButton(135 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "down", FlxColor.BROWN)));
			...
			switch (Action) {
				...
				case CHARACTER_EDITOR:
					...
					actions.add(add(buttonZ = createButton(FlxG.width - 44 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "z", FlxColor.BROWN)));
					actions.add(add(buttonD = createButton(FlxG.width - 170 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "d", FlxColor.BROWN)));
					actions.add(add(buttonF = createButton(FlxG.width - 170 * 3, FlxG.height - 230 * 3, 44 * 3, 127, "f", FlxColor.BROWN)));
					actions.add(add(buttonC = createButton(FlxG.width - 128 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "c", FlxColor.BROWN)));
					actions.add(add(buttonB = createButton(FlxG.width - 86 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "b", FlxColor.BROWN)));								
					actions.add(add(buttonA = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "a", FlxColor.BROWN)));
					dPad.add(add(buttonUp2 = createButton(135 * 3, FlxG.height - 116 * 3, 44 * 3, 127, "up", FlxColor.BROWN)));
			...
			case CHART_EDITOR:
				...
				dPad.add(add(buttonRight = createButton(42 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "right", 0xFF0000)));		
			case CHARACTER_EDITOR:
				dPad.add(add(buttonV = createButton(FlxG.width - 170 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "v", 0x49A9B2)));            
				dPad.add(add(buttonX = createButton(FlxG.width - 128 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "x", 0x99062D)));
				dPad.add(add(buttonY = createButton(FlxG.width - 86 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "y", 0x4A35B9)));
				dPad.add(add(buttonZ = createButton(FlxG.width - 44 * 3, FlxG.height - 85 * 3, 44 * 3, 127, "z", 0xCCB98E)));
				dPad.add(add(buttonD = createButton(FlxG.width - 170 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "d", 0x0078FF)));
				dPad.add(add(buttonF = createButton(FlxG.width - 170 * 3, FlxG.height - 250 * 3, 44 * 3, 127, "f", FlxColor.BROWN)));
				dPad.add(add(buttonC = createButton(FlxG.width - 128 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "c", 0x44FF00)));
				dPad.add(add(buttonB = createButton(FlxG.width - 86 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "b", 0xFFCB00)));								
				dPad.add(add(buttonA = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "a", 0xFF0000)));
				dPad.add(add(buttonUp2 = createButton(135 * 3, FlxG.height - 116 * 3, 44 * 3, 127, "up", 0x00FF00)));
				dPad.add(add(buttonLeft2 = createButton(100, FlxG.height - 81 * 3, 44 * 3, 127, "left", 0xFF00FF)));
				dPad.add(add(buttonRight2 = createButton(169 * 3, FlxG.height - 81 * 3, 44 * 3, 127, "right", 0xFF0000)));
				dPad.add(add(buttonDown2 = createButton(135 * 3, FlxG.height - 45 * 3, 44 * 3, 127, "down", 0x00FFFF)));
			case MenuCharacterEditor:
			    //orgAlpha = 0.75;
