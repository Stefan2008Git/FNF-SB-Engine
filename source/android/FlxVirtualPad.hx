	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode, ?alphaAlt:Float = 0.75, ?antialiasingAlt:Bool = true) {
		...
		if (ClientPrefs.data.gameStyle == 'SB Engine') {
			...
			case CHARACTER_EDITOR:
				...
				dPad.add(add(buttonF = createButton(FlxG.width - 170 * 3, FlxG.height - 250 * 3, 44 * 3, 127, "f", 0xFF00FFFB)));
				...
				dPad.add(add(buttonLeft2 = createButton(130, FlxG.height - 81 * 3, 44 * 3, 127, "left", 0xFF00FF)));
				dPad.add(add(buttonRight2 = createButton(180 * 3, FlxG.height - 81 * 3, 44 * 3, 127, "right", 0xFF0000)));
