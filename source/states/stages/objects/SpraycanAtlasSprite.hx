...
class SpraycanAtlasSprite extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		// #if android canAtlas.anim.onComplete.add(finishCanAnimation); #else canAtlas.anim.onComplete = finishCanAnimation; #end --I dunno how to fix this shit, so it will be gray for now...
