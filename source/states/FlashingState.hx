...
class FlashingState extends MusicBeatState {
	...
	override function create() {
		...
		boyfriend.alpha = 0.7;
		FlxTween.tween(boyfriend, {y: 50}, 1.5, {ease: FlxEase.sineInOut, type: PINGPONG, startDelay: 0.1});
		add(boyfriend);
