...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		visualer = new AudioVisualer(FlxG.sound.music, 0, FlxG.height,  FlxG.width + 20, FlxG.height, 90, 2, FlxColor.WHITE);
		visualer.alpha = 0.6;
		visualer.visible = false;
		add(visualer);
