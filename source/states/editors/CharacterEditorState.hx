...
class CharacterEditorState extends MusicBeatState
{
	...
	function addGhostUI()
	{
		...
		var makeGhostButton:FlxButton = new FlxButton(25, 15, "Make Ghost", function() {
			...
			if(!character.isAnimationNull())
			{
				...
				TraceText.makeTheTraceText('created ghost image');
			}
		});
	...
	function addAnimationsUI()
	{
		...
		var addUpdateButton:FlxButton = new FlxButton(70, animationIndicesInputText.y + 30, "Add/Update", function() {
			...
			TraceText.makeTheTraceText('Added/Updated animation: ' + animationInputText.text);
		});
		...
		var removeButton:FlxButton = new FlxButton(180, animationIndicesInputText.y + 30, "Remove", function() {
			for (anim in character.animationsArray)
				if(animationInputText.text == anim.anim)
				{
					...
					reloadAnimList();
					TraceText.makeTheTraceText('Removed animation: ' + animationInputText.text);
					break;
				}
		});
		reloadAnimList();
	...
	function addCharacterUI()
	{
		...
		var saveCharacterButton:FlxButton = new FlxButton(reloadImage.x, noAntialiasingCheckBox.y + 70, "Save Character", function() {
			saveCharacter();
		});
		...
		tab_group.add(new FlxText(15, singDurationStepper.y - 14, 0, 'Sing Animation length:'));
