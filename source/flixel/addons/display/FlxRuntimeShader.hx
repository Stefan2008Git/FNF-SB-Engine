...
class FlxRuntimeShader extends FlxShader
{
	 ...
	 */
	public function new(fragmentSource:String = null, vertexSource:String = null, #if android glslVersion:Int = 100 #else glslVersion:Int = 120 #end):Void
	{
		_glslVersion = glslVersion;

		if (fragmentSource == null)
		{
			TraceText.makeTheTraceText('Loading default fragment source...');
			glFragmentSource = processFragmentSource(DEFAULT_FRAGMENT_SOURCE);
		}
		else
		{
			TraceText.makeTheTraceText('Loading fragment source from argument...');
	...
	public function setFloat(name:String, value:Float):Void
	{
		...
		if (prop == null)
		{
			TraceText.makeTheTraceText('[WARN] Shader float property ${name} not found.');
			return;
		}
		prop.value = [value];
	}
	...
	public function setInt(name:String, value:Int):Void
	{
		...
		if (prop == null)
		{
			TraceText.makeTheTraceText('[WARN] Shader int property ${name} not found.');
			return;
		}
		prop.value = [value];
	}
	...
	public function setBool(name:String, value:Bool):Void
	{
		...
		if (prop == null)
		{
			TraceText.makeTheTraceText('[WARN] Shader bool property ${name} not found.');
			return;
		}
		prop.value = [value];
	}
	...
	public function setSampler2D(name:String, value:BitmapData)
	{
		...
		if(prop == null)
		{
			TraceText.makeTheTraceText('[WARNING] Shader sampler2D property ${name} not found.');
			return;
		}
		prop.input = value;
	}
