...
class VolumeTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    var bg:Bitmap = new Bitmap(Assets.getBitmapData("assets/images/engineStuff/main/soundtray/volumebox.png"));
    ...
    var backingBar:Bitmap = new Bitmap(Assets.getBitmapData("assets/images/engineStuff/main/soundtray/bars_10.png"));
    backingBar.x = 9;
    backingBar.y = 5;
    ...
    for (i in 1...11)
    {
      var bar:Bitmap = new Bitmap(Assets.getBitmapData("assets/images/engineStuff/main/soundtray/bars_" + i + ".png"));
      bar.x = 9;
      bar.y = 5;
